    ...
    <div className="border rounded-lg p-2 shadow-sm">
        ...
        <TableHeader>
          <TableRow className="bg-primary-normal">
            {[
              ...
              <TableHead key={head} className="font-heading">
                {head}
              </TableHead>
            ))}
          </TableRow>
              ...
              <TableRow key={caseItem.regNo}>
                ...
                <TableCell>
                  ...
                  <Button
                    ...
                    className="mr-2"
                    onClick={() =>
                      router.push(`/pages/judge/case/${caseItem.regNo}`)
                    }>
                    <Eye size={16} />
                  </Button>
                  <Button
                    size="sm"
                    variant="destructive"
                    onClick={() => handleDelete(caseItem.regNo)}>
                    <Trash size={16} />
                  </Button>
                </TableCell>
              </TableRow>
      ...
      <div className="flex justify-between items-center p-2">
        <p className="text-sm">
          ...
          of {cases.filter((c) => c.status === tab).length}
        </p>
        <div>
          <Button
            size="sm"
