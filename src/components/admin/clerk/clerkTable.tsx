...
const ClerkTable = () => {
    ...
    const editClerkMutation = useMutation({
        mutationFn: async (clerk: Clerk) => {
            const response = await fetch(`http://localhost:3001/api/v1/admin/users/${clerk.id}`, {
                method: "PUT",
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'Content-Type': 'application/json'
                ...
                <Table>
                    <TableHeader>
                        {table.getHeaderGroups().map(headerGroup => (
                            <TableRow key={headerGroup.id} className="bg-primary-normal text-white">
                    ...
                    <div className="grid gap-4 py-4">
                        <div className="grid grid-cols-4 items-center gap-4">
                            ...
                            <Input
                                ...
                                onChange={(e) => editingClerk
                                    ? setEditingClerk({ ...editingClerk, email: e.target.value })
                            ...
                            <>
                                ...
                                <div className="grid grid-cols-4 items-center gap-4">
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) => setNewClerk({ ...newClerk, password_confirmation: e.target.value })}
                                        className="col-span-3"
                        ...
                        <div className="grid grid-cols-4 items-center gap-4">
                            ...
                            <Input
                                id="first_name"
                                name="first_name"
                                value={editingClerk ? editingClerk.profile.first_name : newClerk.profile.first_name}
                                onChange={(e) => editingClerk
                                    ? setEditingClerk({
                                        ...editingClerk,
                                        profile: { ...editingClerk.profile, first_name: e.target.value }
                                    })
                                    : setNewClerk({
                                        ...newClerk,
                                        profile: { ...newClerk.profile, first_name: e.target.value }
                                    })
                                }
                                className="col-span-3"
                        ...
                        <div className="grid grid-cols-4 items-center gap-4">
                            ...
                            <Input
                                id="last_name"
                                name="last_name"
                                value={editingClerk ? editingClerk.profile.last_name : newClerk.profile.last_name}
                                onChange={(e) => editingClerk
                                    ? setEditingClerk({
                                        ...editingClerk,
                                        profile: { ...editingClerk.profile, last_name: e.target.value }
                                    })
                                    : setNewClerk({
                                        ...newClerk,
                                        profile: { ...newClerk.profile, last_name: e.target.value }
                                    })
                                }
                                className="col-span-3"
                        ...
                        <div className="grid grid-cols-4 items-center gap-4">
                            ...
                            <Input
                                id="cid_no"
                                name="cid_no"
                                value={editingClerk ? editingClerk.profile.cid_no : newClerk.profile.cid_no}
                                onChange={(e) => editingClerk
                                    ? setEditingClerk({
                                        ...editingClerk,
                                        profile: { ...editingClerk.profile, cid_no: e.target.value }
                                    })
                                    : setNewClerk({
                                        ...newClerk,
                                        profile: { ...newClerk.profile, cid_no: e.target.value }
                                    })
                                }
                                className="col-span-3"
                        ...
                        <div className="grid grid-cols-4 items-center gap-4">
                            ...
                            <Input
                                id="phone_number"
                                name="phone_number"
                                value={editingClerk ? editingClerk.profile.phone_number : newClerk.profile.phone_number}
                                onChange={(e) => editingClerk
                                    ? setEditingClerk({
                                        ...editingClerk,
                                        profile: { ...editingClerk.profile, phone_number: e.target.value }
                                    })
                                    : setNewClerk({
                                        ...newClerk,
                                        profile: { ...newClerk.profile, phone_number: e.target.value }
                                    })
                                }
                                className="col-span-3"
                        ...
                        <div className="grid grid-cols-4 items-center gap-4">
                            ...
                            <Input
                                id="court_id"
                                name="court_id"
                                value={editingClerk ? editingClerk.court.id.toString() : newClerk.court_id}
                                onChange={(e) => editingClerk
                                    ? setEditingClerk({
                                        ...editingClerk,
                                        court: { ...editingClerk.court, id: parseInt(e.target.value) || 0 }
                                    })
                                    : setNewClerk({
                                        ...newClerk,
