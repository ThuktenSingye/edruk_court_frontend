...
export const SendToModal = ({ open, onOpenChange, onSend }: SendToModalProps) => {
    ...
    const [courtOptions, setCourtOptions] = useState<{ id: number; name: string }[]>([]);
                    ...
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl><Input placeholder="Enter message" {...field} /></FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )}
                            />
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl><Input placeholder="Enter order type" {...field} /></FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )}
                            />
                                    ...
                                    <FormItem>
                                        ...
                                        <div className="flex gap-4 mt-1">
                                            <label className="flex items-center gap-2">
                                                <input type="radio" value="court" checked={sendToOption === "court"}
                                                    onChange={() => {
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <select {...field} className="form-select h-10 px-3 border rounded-md">
                            ...
                            <div className="flex justify-between mt-4 gap-5">
                                ...
                                <Button type="button" className="bg-red-500 w-1/2 py-3 text-lg" onClick={() => onOpenChange(false)}>Cancel</Button>
                            </div>
                        </form>
                    </Form>
                </Card>
