          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Input
                ...
                value={
                  editingJudge
                    ? editingJudge.profile.first_name
                    : newJudge.profile.first_name
                }
                onChange={(e) =>
                  editingJudge
                    ? setEditingJudge({
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Input
                ...
                value={
                  editingJudge
                    ? editingJudge.profile.last_name
                    : newJudge.profile.last_name
                }
                onChange={(e) =>
                  editingJudge
                    ? setEditingJudge({
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Input
                ...
                value={
                  editingJudge
                    ? editingJudge.profile.cid_no
                    : newJudge.profile.cid_no
                }
                onChange={(e) =>
                  editingJudge
                    ? setEditingJudge({
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Input
                ...
                value={
                  editingJudge
                    ? editingJudge.profile.phone_number
                    : newJudge.profile.phone_number
                }
                onChange={(e) =>
                  editingJudge
                    ? setEditingJudge({
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <div className="col-span-3 flex flex-col">
                <Select
                  value={
                    editingJudge
                      ? editingJudge.court.id.toString()
                      : newJudge.court_id
                  }
                  onValueChange={(value) =>
                    editingJudge
                      ? setEditingJudge({
                          ...editingJudge,
                          court: { ...editingJudge.court, id: parseInt(value) },
                        })
                      : setNewJudge({
                          ...newJudge,
                          court_id: value,
