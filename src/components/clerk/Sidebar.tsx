...
const Sidebar = () => {
    ...
    const menuItems = [
        { name: "Dashboard", path: "/pages/clerk/dashboard", icon: <AiFillAppstore /> },
        { name: "Cases", path: "/pages/clerk/case", icon: <AiFillFile /> },
        { name: "Case Docs", path: "/pages/clerk/casedocs", icon: <AiFillFolderOpen /> },
        { name: "Calendar", path: "/pages/clerk/calendar", icon: <FaCalendarAlt /> },
        { name: "Order", path: "/pages/clerk/courtorder", icon: <FaRegFileAlt /> },
        { name: "Report", path: "/pages/clerk/report", icon: <FaFileInvoice /> },
    ];
