...
export const NotificationItem: React.FC<NotificationItemProps> = ({
    ...
    const handleMarkAsReadClick = async () => {
        ...
        console.log(`POST request initiated for notification ID: ${notification.id}. Hiding item.`);
    ...
    return (
        ...
        <div
            className={`w-full bg-white border border-gray-300 shadow-2xl rounded-lg p-4 md:p-8 text-green-600 transition-opacity duration-300`}
        >
            <div className="space-y-6 md:space-y-8">
                ...
                <div className="flex flex-col md:flex-row gap-6 md:gap-8">
                    ...
                    <div className="flex flex-col w-full md:w-1/2 space-y-2 md:space-y-4">
                        <label className="text-md font-medium" htmlFor={`description-${notification.id}`}>
                    ...
                    <div className="flex flex-col space-y-2 md:space-y-4">
                        ...
                        <div className="flex flex-row items-center gap-2">
                            <label className="text-md font-medium">Court ID:</label>
                            <p className="text-md">{String(notification.court_id)}</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="mt-4">
                    <button
                        ...
                        className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-neutral-950 disabled:pointer-events-none disabled:opacity-50 border bg-white shadow-sm hover:bg-neutral-100 text-green-700 border-green-700 px-6 h-9 py-2"
                    >
