...
interface Document {
    ...
    fileDate: string;
    fileUrl: string;
    verified: boolean | null; // null = pending, true = accepted, false = denied
}

const initialDocuments: Document[] = [
    { fileName: "FileName.pdf", fileDate: "31 Dec, 2024", fileUrl: "/mydocument.pdf", verified: null },
    { fileName: "Report.pdf", fileDate: "15 Jan, 2025", fileUrl: "/mydocument.pdf", verified: null },
    { fileName: "Invoice.pdf", fileDate: "10 Feb, 2025", fileUrl: "/mydocument.pdf", verified: null },
];
            ...
            <div className="space-y-2 mt-2">
                {documents.length > 0 ? (
                    documents.map((doc, index) => (
                        <div key={index} className="flex flex-col md:flex-row md:items-center justify-between bg-gray-100 p-3 rounded-md shadow-md gap-3">
