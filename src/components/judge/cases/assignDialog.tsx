        ...
        <div className="p-6 max-w-4xl mx-auto">
            ...
            <Dialog>
                <DialogTrigger asChild>
                    <Button variant="outline" className="mb-4">Open Dialog</Button>
                </DialogTrigger>
                ...
                <DialogContent className="sm:max-w-md">
                    ...
                    <form>
                        {/* Bench Radio Group */}
                        <div className="mb-4">
                            <label htmlFor="bench" className="block text-sm font-medium text-gray-700">
                                Select Bench
                            </label>
                            <div className="flex items-center space-x-4">
                                <div className="flex items-center">
                                    ...
                                    />
                                    <label htmlFor="bench1" className="ml-2 text-sm">Bench 1</label>
                                </div>
                                <div className="flex items-center">
                                    <input
                                        type="radio"
                                        ...
                                        className="h-4 w-4 text-primary-normal border-gray-300 focus:ring-primary-normal"
                                    />
                                    <label htmlFor="bench2" className="ml-2 text-sm">Bench 2</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="mb-4">
                            <label htmlFor="clerk" className="block text-sm font-medium text-gray-700">
                                Select Clerk
                            </label>
                            <select
                                id="clerk"
